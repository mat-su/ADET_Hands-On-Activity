...
public class act5_MouseMotionDemo extends Frame implements MouseListener, MouseMotionListener { 
	...
	public static void main(String[] args) { 
		new act5_MouseMotionDemo(); // Let the constructor do the job 
		} 
